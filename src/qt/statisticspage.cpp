...
void StatisticsPage::updateStatistics()
{
    ...
    QString phase = "";
    if (pindexBest->nHeight+1 > 0 && pindexBest->nHeight+1 <= 700)
    {
        phase = "POW phase";
    }
	    else if (pindexBest->nHeight+1 > 700 && pindexBest->nHeight+1 <= 17280)
    {
        phase = "POW/POS phase";
    }
    else if (pindexBest->nHeight+1 > 17280)
    {
        phase = "POS phase";
    }
    ...
    {
        ui->volumeBox->setText("<b><font color=\"#ebbcff\">" + qVolume + " BST" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"red\">" + qVolume + " BST" + "</font></b>");
    } else {
        ui->volumeBox->setText(qVolume + " BST");
    }
